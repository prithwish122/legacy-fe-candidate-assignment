    ...
    <section className="w-full py-40 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative h-full min-h-[500px] rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 overflow-hidden p-8">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  {/* Title */}
                  <h3 className="text-2xl md:text-3xl font-semibold text-white mb-3 tracking-tight">{phase.title}</h3>

                  <p className="text-base font-medium text-white/70 mb-6">{phase.subtitle}</p>

                  {/* Description */}
                  <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-8">{phase.description}</p>
        ...
        >
          ...
          <p className="text-white/50 text-xs mt-3">Centralize, collaborate, and communicate smarter</p>
        </motion.div>
      </div>
    </section>
  )
